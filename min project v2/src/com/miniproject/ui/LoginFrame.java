...
public class LoginFrame extends JFrame {
    ...
    public LoginFrame() {
        setTitle("Gestion Absences - Login");
        setSize(400, 300);
        ...
        gbc.gridx = 1;
        String[] roles = { "ETUDIANT", "ENSEIGNANT", "RESPONSABLE" };
    ...
    private void handleLogin(ActionEvent e) {
        ...
        if (user != null) {
            JOptionPane.showMessageDialog(this, "Bienvenue " + user.getFirstName() + " (" + user.getRole() + ")");
            new MainDashboard(user).setVisible(true);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Login ou mot de passe incorrect pour le rôle " + role, "Erreur",
