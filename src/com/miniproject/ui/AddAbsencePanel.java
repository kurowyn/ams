...
public class AddAbsencePanel extends JPanel {
    ...
    public AddAbsencePanel(User user) {
        ...
        JButton btnLoad = new JButton("Charger Etudiants");
        ...
        // Table with Checkbox
        modelStudents = new DefaultTableModel(new Object[] { "ID", "Nom", "Prénom", "Absent?" }, 0) {
            @Override
        ...
        JButton btnSave = new JButton("Enregistrer Absences");
    ...
    private void saveAbsences() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, count + " absences enregistrées.");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Erreur: Vérifiez le format de date (yyyy-MM-dd)");
            ex.printStackTrace();
        }
    }
}
